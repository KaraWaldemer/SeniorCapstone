...
@Purpose: Creates the page to view all found entries in the database
*/

require_once "Templates/info.php";
$title = "Found Dog Listings";
...
_END;
if(isset($_SESSION['loggedIn'])) //determine header based on if user is logged in
{
...
/*gets all found entries and populates page*/
$result = find('1');
